...
class RemindersActivityTest :
    ...
    private val dbIdlingResource = DataBindingIdlingResource()
    ...
    fun registerIdlingResources() {
        IdlingRegistry.getInstance().register(dbIdlingResource)
    }

    @After
    fun unregisterIdlingResources() {
        IdlingRegistry.getInstance().unregister(dbIdlingResource)
    }

    @Test
    fun saveReminderNoTitle_showCorrectSnackbar() {
    ...
    @Test
    fun saveReminderNoLocation_showCorrectSnackbar() {
        val activityScenario = launch(RemindersActivity::class.java)
        dbIdlingResource.monitorActivity(activityScenario)
